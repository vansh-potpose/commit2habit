    ...
    return (
        <div>
            ...
            <div className='flex justify-center w-screen items-start'>
                <div className={`flex mx-auto   justify-center ${showingChallenges ? ' flex-col items-center ' : 'md:flex-row flex-col md:my-14 my-8'}`}>

                    <div className={`profile_info flex ${showingChallenges ? "flex-row items-center gap-3 flex-grow w-full px-1" : "md:flex-col md:gap-0 md:items-start md:px-0 flex-row gap-3 items-center px-1"} `}>
                        <img className={`image_container ${showingChallenges ? "w-16 h-16 mt-5" : "md:w-80 md:h-80 md:mt-0 w-16 h-16"} rounded-full object-center overflow-hidden border border-borderColor mb-5 object-cover `} src={profile_pic || "/profile.png"} alt="profile" />
                    ...
                    <div>
                        ...
                        <h1 className='font-semibold text-2xl'>Status</h1>
                            ...
                            <div className={`${!showingChallenges?"md:flex hidden":"hidden"} levels w-full flex flex-col justify-center items-center`}>
                ...
                {
                    showingChallenges &&
                    <div className="challenges md:relative absolute md:min-w-[50%] xl:min-w-[65%] min-w-full min-h-full">
